    ...
    <div className="max-w-7xl mx-auto space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 px-3 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase text-indigo-600">
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              ...
              className="bg-white border border-slate-200 pl-11 pr-4 h-12 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-indigo-500/50 transition-all w-64 shadow-sm"
            />
          </div>
          <button 
            onClick={() => fetchUsers()}
            className="bg-white p-3 rounded-xl border border-slate-200 text-slate-400 hover:text-indigo-600 transition-all shadow-sm"
          >
        ...
        <div className="p-6 bg-slate-50/50 border-t border-slate-100 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className="p-2 bg-white border border-slate-200 rounded-xl disabled:opacity-30 hover:text-indigo-600 transition-all shadow-sm"
            >
              <ChevronLeft size={20} />
            </button>
            <button 
        ...
        {confirmDelete && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white p-8 rounded-3xl border border-rose-100 shadow-2xl space-y-6"
            >
              ...
              <div className="flex gap-4">
                <button 
                  onClick={() => setConfirmDelete(null)}
                  className="flex-1 h-12 bg-slate-50 border border-slate-200 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-slate-100 transition-colors"
                >
                  Cancel
                </button>
                <button 
        ...
        {selectedUser && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 50 }}
              className="relative w-full max-w-4xl bg-white p-10 rounded-[40px] border border-slate-200 shadow-2xl space-y-8"
            >
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-5">
                  <div className="w-16 h-16 rounded-3xl bg-gradient-to-br from-indigo-500 to-blue-600 flex items-center justify-center text-2xl font-black text-white shadow-xl">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Daily classification density breakdown</p>
                  </div>
        ...
        {notifyingUser && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              exit={{ opacity: 0, scale: 0.9 }}
              className="relative w-full max-w-lg bg-white p-8 rounded-[32px] border border-slate-200 shadow-2xl space-y-6"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Recipient: {notifyingUser.username}</p>
                </div>
              </div>
