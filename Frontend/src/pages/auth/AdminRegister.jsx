...
import { Mail, Lock, User, ShieldCheck, Zap, ChevronRight, Key } from "lucide-react";
...
export const AdminRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Admin identity established.");
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Admin Enrollment</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            <label className="text-[10px] font-bold tracking-widest text-slate-500 uppercase ml-1">Admin Username</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold tracking-widest text-slate-500 uppercase ml-1">Admin Setup Key</label>
            <div className="relative group">
              <Key size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors" />
              <input 
                type="password" 
                required 
        ...
        <div className="mt-8 text-center border-t border-slate-100 pt-8">
           <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
             Already authorized? {" "}
             <Link to="/admin/login" className="text-indigo-600 hover:text-indigo-700 transition-colors ml-1">
               Admin Login
             </Link>
           </p>
        </div>
